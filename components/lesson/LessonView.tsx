...
export default function LessonView({
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      {/* Bottom bar */}
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-white/90 dark:bg-slate-900/90 backdrop-blur border-t border-slate-200 dark:border-slate-800 px-4 py-3">
      ...
      {showXp && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className="fixed bottom-24 left-1/2 -translate-x-1/2 bg-blue-600 text-white font-bold px-4 py-2 rounded-full shadow-lg text-sm z-50"
        >
          +20 XP ✈️
        </motion.div>
      )}
